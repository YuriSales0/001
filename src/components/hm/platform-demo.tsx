  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl p-6 text-center" style={{ background: "var(--hm-ivory, #FDFCF8)", border: "1px solid #E8E3D8" }}>
        ...
        <p className="text-4xl font-bold" style={{ color: "#111827" }}>€3,240</p>
        <div className="mt-3 max-w-xs mx-auto">
          <div className="flex justify-between text-xs text-gray-500 mb-1">
            <span>{t('demo.dashboard.features.1')}</span>
            <span className="font-semibold" style={{ color: "#111827" }}>78%</span>
          </div>
          <div className="h-2 rounded-full bg-gray-200 overflow-hidden">
            <div className="h-full rounded-full" style={{ width: "78%", background: "#C9A84C" }} />
          </div>
        </div>
      </div>
      {/* Cards row */}
      <div className="grid grid-cols-3 gap-3">
        <div className="rounded-lg p-3 border" style={{ borderColor: "#E8E3D8" }}>
          <div className="flex items-center gap-2 mb-1">
            <Flag className="h-3.5 w-3.5" style={{ color: "#C9A84C" }} />
            <span className="text-[10px] uppercase tracking-wider text-gray-400">{t('demo.dashboard.features.2')}</span>
          </div>
          <p className="font-semibold text-sm" style={{ color: "#111827" }}>🇬🇧 James W.</p>
    ...
    <div className="space-y-1">
      ...
      {bookings.map((b, i) => (
        <div key={i} className="grid grid-cols-4 items-center rounded-lg px-3 py-2.5 text-sm hover:bg-gray-50 transition-colors" style={{ borderBottom: "1px solid #f3f4f6" }}>
          <span className="font-medium" style={{ color: "#111827" }}>{b.guest}</span>
          ...
          <span className="text-right font-semibold text-sm" style={{ color: "#111827" }}>{b.amount}</span>
        </div>
      ))}
    ...
    <div className="space-y-4">
      <div className="rounded-xl overflow-hidden border" style={{ borderColor: "#E8E3D8" }}>
        <div className="px-4 py-3 flex justify-between items-center" style={{ background: "#FAFAF8" }}>
          <span className="text-sm font-semibold" style={{ color: "#111827" }}>July 2026 Statement</span>
          <span className="text-xs rounded-full px-2.5 py-0.5 font-medium" style={{ background: "rgba(201,168,76,0.15)", color: "#C9A84C" }}>PDF ↓</span>
        </div>
        <div className="divide-y" style={{ borderColor: "#f3f4f6" }}>
          {[
            { label: "Gross rental income", value: "€4,720", color: "#111827" },
          ...
          <div className="px-4 py-3 flex justify-between text-sm font-bold" style={{ background: "#FAFAF8" }}>
            <span style={{ color: "#111827" }}>Net payout</span>
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-lg p-4 border" style={{ borderColor: "#E8E3D8" }}>
          ...
          <p className="text-2xl font-bold" style={{ color: "#111827" }}>2</p>
        </div>
        <div className="rounded-lg p-4 border" style={{ borderColor: "#E8E3D8" }}>
        ...
        {visits.map((v, i) => (
          <div key={i} className="px-4 py-3 flex items-center justify-between" style={{ borderBottom: i < visits.length -1 ? "1px solid #f3f4f6" : "none" }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium" style={{ color: "#111827" }}>{v.type}</p>
      ...
      <div className="rounded-xl border overflow-hidden" style={{ borderColor: "#E8E3D8" }}>
        ...
        <div className="p-4 space-y-3" style={{ background: "#FAFAF8" }}>
          <div className="flex justify-end">
            <div className="rounded-xl rounded-tr-sm px-4 py-2.5 text-sm max-w-[75%]" style={{ background: "#111827", color: "#fff" }}>
              Hi Ana, can you check the air conditioning? Guest mentioned it was slow to cool.
            </div>
          </div>
          <div className="flex justify-start">
            <div className="rounded-xl rounded-tl-sm px-4 py-2.5 text-sm max-w-[75%] border" style={{ background: "#fff", borderColor: "#E8E3D8", color: "#111827" }}>
