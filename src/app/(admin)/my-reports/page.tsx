    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-navy-900 text-white text-sm font-medium hover:bg-navy-800 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        >
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="rounded-lg border border-gray-200 px-3 py-2 text-sm bg-white text-navy-900 focus:outline-none focus:ring-2 focus:ring-navy-300"
          >
        ...
        <>
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50 px-5 py-4">
            <p className="text-sm text-gray-500">
              <span className="font-semibold text-navy-900">{report.property.name}</span>
              {" — "}{MONTHS[month]} {year}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="rounded-xl border border-gray-200 bg-white p-5">
              ...
              <p className="text-2xl font-bold text-navy-900">{fmtEUR(report.grossRevenue)}</p>
            </div>
            <div className="rounded-xl border border-gray-200 bg-white p-5">
            ...
            <div className="rounded-xl border bg-navy-900 p-5">
                ...
                <tbody>
                  {report.reservations.map(r => (
                    <tr key={r.id} className="border-b border-gray-50 last:border-0">
                      <td className="px-5 py-3 font-medium text-navy-900">{r.guestName}</td>
                  ...
                  <tr className="bg-gray-50">
                    <td className="px-5 py-3 font-bold text-navy-900" colSpan={4}>Total Income</td>
                ...
                <tbody>
                  {report.expenses.map(e => (
                    <tr key={e.id} className="border-b border-gray-50 last:border-0">
                      <td className="px-5 py-3 text-navy-900">{e.description}</td>
                  ...
                  <tr className="bg-gray-50">
                    <td className="px-5 py-3 font-bold text-navy-900" colSpan={3}>Total Expenses</td>
          ...
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-5">
            <div className="space-y-2 text-sm">
              ...
              <div className="border-t border-gray-300 pt-3 flex justify-between text-base">
                ...
                <span className="font-bold text-navy-900">{fmtEUR(report.ownerPayout)}</span>
              </div>
            </div>
          </div>
        </>
