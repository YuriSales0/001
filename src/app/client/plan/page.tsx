...
const PLANS: PlanConfig[] = [
  ...
  },
  {
    ...
    features: [
      "Everything in Basic",
      "AI competitor pricing analysis",
      "Automatic price recommendations",
      "Priority owner response within 12 hours",
      "Priority guest response within 2 hours",
  ...
  },
  {
    ...
    features: [
      "Everything in Mid",
      "Airport transfer (Málaga & Granada)",
      "Laundry & premium bed linen",
      "Grocery delivery before guest arrival",
      "All guest upsells activated automatically",
