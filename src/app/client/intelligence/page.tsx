    ...
    <div className="space-y-6">
      <div>
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-semibold text-navy-900">{t('client.intelligence.title')}</h1>
      ...
      <div className="rounded-xl border p-4 flex items-start gap-3" style={{ background: 'rgba(176,138,62,0.04)', borderColor: 'rgba(176,138,62,0.15)' }}>
        ...
        <div>
          <p className="text-sm font-semibold text-navy-900">{t('client.intelligence.monitoring')}</p>
      ...
      {data ? (
        ...
        <div className="rounded-xl border bg-white p-10 text-center">
          ...
          <h3 className="font-semibold text-navy-900 mb-1">{t('client.intelligence.dataCollection')}</h3>
      ...
      <div className="rounded-xl border bg-gray-50 p-5">
        ...
        <div className="grid sm:grid-cols-3 gap-4 text-sm">
          <div>
            <p className="font-semibold text-navy-900 mb-1">{t('client.intelligence.phase1')}</p>
            <p className="text-xs text-gray-500">{t('client.intelligence.phase1Desc')}</p>
          </div>
          <div>
            <p className="font-semibold text-navy-900 mb-1">{t('client.intelligence.phase2')}</p>
            <p className="text-xs text-gray-500">{t('client.intelligence.phase2Desc')}</p>
          </div>
          <div>
            <p className="font-semibold text-navy-900 mb-1">{t('client.intelligence.phase3')}</p>
